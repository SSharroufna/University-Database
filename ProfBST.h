...
class ProfBST
{
    ...
    private:
        ...
        Professor *root;
		Professor *addProfessorHelper(Professor *root, Professor *newProfessor);
		Professor *searchProfessorHelper(Professor *root, string profId);
		void deleteHelper(Professor *temp);
};
